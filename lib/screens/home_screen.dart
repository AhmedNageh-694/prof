...
const _categories = ['All', 'Creative', 'Engineering', 'Business', 'Analytics'];
...
class _HomeScreenState extends State<HomeScreen> with SingleTickerProviderStateMixin {
  ...
  List<Module> get _filtered {
    return _modules.where((m) {
      ...
      final matchCategory =
          _activeCategory == 'All' || m.category == _activeCategory;
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      gradient: const LinearGradient(
                        colors: [Color(0xFF0D9488), Color(0xFF3B82F6)], // Teal to Blue
                    ...
                    child: SearchBarWidget(
                      ...
                      onFilterTap: () {
                        setState(() {
                          ...
                          if (!_filterActive) _activeCategory = 'All';
                        });
                      },
                  ...
                  AnimatedCrossFade(
                    ...
                    crossFadeState: _filterActive ? CrossFadeState.showSecond : CrossFadeState.showFirst,
                    duration: const Duration(milliseconds: 300),
                  ...
                  child: Column(
                    ...
                    children: [
                      Container(
                        ...
                        child: const Icon(Icons.search_off_rounded, size: 56, color: AppColors.primary),
                      ),
                      const SizedBox(height: 20),
                      Text(
                        'No modules found',
                        style: GoogleFonts.inter(fontSize: 18, fontWeight: FontWeight.w700, color: AppColors.foreground),
                      ),
                      const SizedBox(height: 8),
                      Text(
                ...
                delegate: SliverChildBuilderDelegate(
                  (context, index) {
                    return TweenAnimationBuilder<double>(
                      ...
                      curve: Curves.easeOutCubic,
                      builder: (context, value, child) {
                        // Create a staggering effect for each card
                        final delay = index * 0.1;
                        final adjustedValue = (value * 1.5 - delay).clamp(0.0, 1.0);
